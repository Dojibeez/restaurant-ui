  ...
  return (
    <div className="h-screen w-screen max-w-[100%] relative text-[#060c08] dark:text-slate-200 flex items-center justify-center">
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex flex-col gap-y-28 items-center justify-center p-10 py-24 border border-[#060c08]/10 dark:border-slate-200/10 relative"
      >
        ...
        <h1 className="font-nanum uppercase text-3xl tracking-[4px] ">
          Make a reservation
        </h1>
